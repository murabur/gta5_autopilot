...
while True:
    ...
    #görüntüyü 1ms ekranda bekletir. 0 olursa tek bir görüntüyü kapatılasıya dek basar. Yüksek olursa FPS'i sınırlar.  "Döngü her saniye 1000 kez dönmeye çalışır, kameranın hızı (FPS) neyse görüntü o hızda akar."
